...
public class BlogApplication {
	...
	public CommandLineRunner populateUsuario(UsuarioRepository repo) {
		...
		return args -> {
			repo.save(new Usuario(1, "Giugiu ademir", "giu", "senha123", "default.png", "lorem ipsum ai que dor", admin));
	...
	public CommandLineRunner populatePost(PostRepository repo) {
		...
		Usuario giu = new Usuario(1, "Giugiu ademir", "giu", "senha123", "default.png", "lorem ipsum ai que dor", admin);
